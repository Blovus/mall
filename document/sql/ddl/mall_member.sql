...
(
    `id_mall_user` bigint(18)     NOT NULL COMMENT '主键id',
    ...
    `create_by`    bigint(18)              DEFAULT NULL COMMENT '创建用户',
    `create_time`  timestamp   NOT NULL DEFAULT NOW() COMMENT '创建时间',
    `update_by`    bigint(18)              DEFAULT NULL COMMENT '更新用户',
...
(
    `id_mall_user_token` bigint(18)      NOT NULL COMMENT '主键id',
    `id_mall_user`       bigint(18)               DEFAULT '1' COMMENT '用户会员表id',
    ...
    `create_by`          bigint(18)      NOT NULL COMMENT '创建用户',
    `create_time`        timestamp    NOT NULL DEFAULT NOW() COMMENT '创建时间',
    `update_by`          bigint(18)      NOT NULL COMMENT '更新用户',
    `update_time`        timestamp    NOT NULL DEFAULT NOW() COMMENT '更新时间',
