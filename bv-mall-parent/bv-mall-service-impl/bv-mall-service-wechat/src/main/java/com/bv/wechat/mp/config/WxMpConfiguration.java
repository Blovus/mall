package com.bv.wechat.mp.config;

import com.bv.wechat.mp.handler.*;
...
public class WxMpConfiguration {
    ...
    private final ThreadLocal<MenuHandler> menuHandler = new ThreadLocal<MenuHandler>();
    ...
    public WxMpConfiguration(LogHandler logHandler, NullHandler nullHandler, KfSessionHandler kfSessionHandler,
        ...
        this.menuHandler.set(menuHandler);
    ...
    private WxMpMessageRouter newRouter(WxMpService wxMpService) {
        ...
        // 自定义菜单事件
        newRouter.rule().async(false).msgType(XmlMsgType.EVENT)
                .event(MenuButtonType.CLICK).handler(this.menuHandler.get()).end();
