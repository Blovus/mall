...
public class MemberLoginServiceImpl extends BaseApiService<JSONObject> implements MemberLoginService {
    ...
    public BaseResponse<JSONObject> login(@RequestBody UserLoginInpDTO userLoginInpDTO) {
        ...
        if (null != userTokenDo) {
            Boolean removeFlag = generateToken.removeToken(userTokenDo.getUserToken());
            if (removeFlag) {
                userTokenMapper.deleteByUserIdAndloginType(userId, loginType);
            }
        }
        ...
        userTokenMapper.insert(newUserTokenDO);
